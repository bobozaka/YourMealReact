          ...
          <div className={styles.footer__content}>
            ...
            <address className={styles.footer__address}>
              <div className={styles.footer__contact}>
                ...
                <a className={styles.footer__phone} href="tel:+79308333811">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <div className={styles.footer__contact}>
                <h2 className={classNames(styles.footer__title, styles.footer__title_sn)}>
                  Мы в соцсетях
                </h2>

                <ul className={styles.footer__list}>
                  <li className={styles.footer__item}>
                    <a href="#" className={styles.footer__sn} aria-label="группа в вк">
                      <svg
                        width="36"
                        height="36"
                        viewBox="0 0 36 36"
                  ...
                  <li className={styles.footer__item}>
                    <a href="#" className={styles.footer__sn} aria-label="канал в telegram">
                      <svg
                        width="36"
                        height="36"
                        viewBox="0 0 36 36"
